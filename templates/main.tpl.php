            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item"><a class="nav-link <?php if($module == 'orders') { echo 'active'; } ?>" aria-current="page" href="index.php?module=orders&action=list">Orders</a></li>
                        <li class="nav-item"><a class="nav-link <?php if($module == 'users') { echo 'active'; } ?>" href="index.php?module=users&action=list">Users</a></li>
                        <li class="nav-item"><a class="nav-link <?php if($module == 'roles') { echo 'active'; } ?>" href="index.php?module=roles&action=list">Roles</a></li>
